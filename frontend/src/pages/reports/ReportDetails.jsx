...
//     report.repository?.repositoryName || "Unknown Repository";
...
//             <span className="inline-flex items-center gap-2 bg-green-500/10 text-green-400 border border-green-500/20 px-4 py-2 rounded-xl text-sm">
//               <FaFileCsv />
//               CSV Report
//             </span>
//           ) : (
//             <span className="inline-flex items-center gap-2 bg-red-500/10 text-red-400 border border-red-500/20 px-4 py-2 rounded-xl text-sm">
//               <FaFileAlt />
//               PDF Report
//             </span>
//           )}
...
//               Basic details about this sustainability report.
//             </p>
//           </div>
//         </div>
...
//                 <FaLeaf className="text-primary-400" size={20} />
//               </div>
//             </div>
//           </Card>
...
//                 <FaCloud className="text-blue-400" size={20} />
//               </div>
//             </div>
//           </Card>
...
//               <div
//                 key={index}
//                 className="flex items-start gap-3 bg-dark-900/50 border border-dark-700 rounded-xl p-4"
//               >
//                 <div className="w-6 h-6 rounded-full bg-primary-500/10 text-primary-400 flex items-center justify-center text-xs font-semibold flex-shrink-0">
//                   {index + 1}
//                 </div>
