 ...
 * Added specifically for AI suggestions, which need real package names to
 * give useful advice (e.g. "moment is heavy, consider date-fns") — a bare
 * count can't support that. Capped to 40 names to keep the AI prompt small.
 * Returns { dependencies: [...], devDependencies: [...] } — both empty
 * arrays if the repo has no package.json (non-Node project).
 */
